...
@ObjectModel.sapObjectNodeType.name: 'ZINCIDENCIA_20'
@EndUserText.label: '###GENERATED Core Data Service Entity'

define root view entity ZR_INCIDENCIA_20
  as select from zincidencia_20

  association [0..1] to ZI_PRIORIDAD_VH_20 as _Prioridad
